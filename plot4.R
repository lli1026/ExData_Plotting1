...
png("C:/Users/liel/Documents/GitHub/ExData_Plotting1/plot4.png", width=480, height=480)
par(mfrow=c(2,2))
with(powSm, plot(datetime,Global_active_power,xlab="",ylab="Global Active Power(kilowatts)",type = "l"))
with(powSm, plot(datetime,Voltage,ylab="Voltage",type = "l"))
...
with(powSm, plot(datetime,Global_reactive_power,ylab="Global Reactive Power",type = "l"))       
dev.off()
